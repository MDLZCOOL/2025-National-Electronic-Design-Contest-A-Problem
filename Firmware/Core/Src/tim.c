...
void MX_TIM1_Init(void)
{
  ...
  sBreakDeadTimeConfig.DeadTime = 102;
...
void HAL_TIM_MspPostInit(TIM_HandleTypeDef* timHandle)
{
  ...
  /* USER CODE END TIM1_MspPostInit 0 */
    ...
    PE13     ------> TIM1_CH3
    */
    GPIO_InitStruct.Pin = INV_U_N_Pin|INV_U_Pin|INV_V_N_Pin|INV_V_Pin
                          |INV_W_N_Pin|INV_W_Pin;
  ...
  /* USER CODE END TIM8_MspPostInit 0 */
    ...
    PC8     ------> TIM8_CH3
    */
    GPIO_InitStruct.Pin = CON_U_N_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
    GPIO_InitStruct.Alternate = GPIO_AF3_TIM8;
    HAL_GPIO_Init(CON_U_N_GPIO_Port, &GPIO_InitStruct);

    GPIO_InitStruct.Pin = CON_V_N_Pin|CON_W_N_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
    GPIO_InitStruct.Alternate = GPIO_AF3_TIM8;
    ...
    GPIO_InitStruct.Pin = CON_U_Pin|CON_V_Pin|CON_W_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
    GPIO_InitStruct.Alternate = GPIO_AF3_TIM8;
